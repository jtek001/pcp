...
<head>
    ...
    <style>
        ...
        /* --- INÍCIO DA ALTERAÃO: Estilo da Etiqueta (07/06/2025 - IA) --- */
        .header-section {
            display: flex;
        ...
        .obs-section { /* Esta seção será removida do HTML, mas os estilos ficam caso queira re-adicionar no futuro */
        ...
        @media print {
            ...
            /* Oculta elementos que não devem ser impressos, como botões */
            .no-print {
                display: none;
            }
        }
