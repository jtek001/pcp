<?php
// modules/ordens_producao/get_products_for_op.php
// Este script é um endpoint AJAX que busca produtos para o campo de seleção de OP.
...
if (!empty($search_term)) {
    // Busca produtos por nome ou código, filtrando por acabamento 'Acabado'
    ...
    try {
        ...
        if ($result) {
            ...
            error_log("Erro ao buscar produtos para AJAX: " . $conn->error);
        }
    } catch (mysqli_sql_exception $e) {
        error_log("Erro fatal ao buscar produtos para AJAX: " . $e->getMessage());
    }
}
